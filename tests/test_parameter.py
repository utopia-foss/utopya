...
from utopya.parameter import extract_validation_objects as _extract
from utopya.yaml import load_yml, yaml
...
def test_Parameter_validation():
    ...
    for case_name, case_cfg in chain(
        cfg["to_assert"].items(), cfg["shorthands"].items()
    ):
